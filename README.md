About google-cloud-iam-feedstock
================================
...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/google-cloud-iam-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/google-cloud-iam-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add google-cloud-iam
# for installing globally
pixi global install google-cloud-iam
```
...
It is possible to list all of the versions of `google-cloud-iam` available on your platform:
...
```
pixi search google-cloud-iam --channel conda-forge
```
